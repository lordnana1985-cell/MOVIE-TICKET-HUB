...
export const DEFAULT_MOVIES: MovieTicket[] = [
  {
    ...
    description:
      'A mind-bending sci-fi epic exploring the outer boundaries of human perception when a celestial event triggers dimensional shifts.',
  ...
  },
  {
    ...
    description:
      'An emotional romance set in the highlands, where music, destiny, and memories collide over a single majestic summer.',
    price: 100, // GH₵100
    date: '2026-09-01',
    time: '20:00',
  ...
  },
  {
    ...
    description:
      'A historical drama following the rise of an empire, filled with betrayals, glorious battles, and a quest for absolute crown.',
    price: 250, // GH₵250
    date: '2026-08-20',
    time: '17:00',
