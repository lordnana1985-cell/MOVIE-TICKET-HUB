...
import { X, ExternalLink, ArrowRight, Clock, CheckCircle2 } from 'lucide-react';
            ...
            <div key={item.ticket.id} className="flex justify-between items-center text-xs">
              <div className="min-w-0 pr-2">
                ...
                <span className="text-[10px] text-gray-400 font-mono">
                  Qty: {item.quantity} x GH₵{item.ticket.price}
                </span>
              </div>
        ...
        {paystackStep === 'details' && (
          <div className="p-5 space-y-4">
            <p className="text-xs text-gray-300 leading-relaxed">
              You are about to be redirected to the secure external Paystack Shop portal to complete
              your payment of <strong className="text-gold">GH₵{cartTotal.toLocaleString()}</strong>
              .
            </p>
            <div className="rounded-xl bg-white/5 p-3 flex items-start gap-2.5 text-xs text-gray-400 border border-white/5">
              ...
              <span>
                The official Paystack merchant gateway will load in this browser window. Use
                standard back or cancel controls as needed.
              </span>
            </div>
        ...
        {paystackStep === 'otp' && (
          <div className="p-5 space-y-4 text-center">
            ...
            <p className="text-xs text-gray-400 leading-relaxed max-w-[280px] mx-auto">
              Please finish your secure checkout on the Paystack gateway. Once you are done, click
              the button below to confirm your payment and claim your active passes.
            </p>
        ...
        {paystackStep === 'success' && (
          <div className="p-8 text-center space-y-3 animate-fadeIn">
            ...
            <p className="text-xs text-gray-400">
              Your tickets are being generated and dispatched to your <strong>My Passes</strong>{' '}
              dashboard.
            </p>
          </div>
        )}
